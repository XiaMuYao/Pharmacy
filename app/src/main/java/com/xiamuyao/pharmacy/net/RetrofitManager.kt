...
import com.xiamuyao.pharmacy.App
import com.xiamuyao.pharmacy.api.ApiService
...
//                .addQueryParameter("From", "Container")
                .build()
...
//                .header("Anonymization", "Bearer $token")
            ...
            synchronized(RetrofitManager::class.java) {
                if (retrofit == null) {
                    ...
                    retrofit = Retrofit.Builder()
                        .baseUrl(ProjectConstant.getBaseUrl())
                        .client(client!!)
